...
export function buildEmployerCompanySubmittedEmailHtml({ name, companyName }) {
  const displayName = name || "there";

  return wrapEmailHtml(`
      <h2 style="margin-bottom:8px;">Company profile submitted</h2>
      <p>Hello ${displayName},</p>
      <p>Thank you for registering as an employer on WorkaHive.</p>
      <p>Your company profile has been successfully submitted and is currently under review by our verification team.</p>
      <p>As part of our commitment to maintaining a trusted and credible hiring platform, all employer accounts are manually reviewed before job posting access is granted. This verification process may include checks such as:</p>
      <ul style="margin:0 0 16px 20px;padding:0;">
        <li>Business registration details (e.g. RC Number)</li>
        <li>Social media presence</li>
        <li>Online credibility and brand authenticity</li>
        <li>Other relevant verification criteria</li>
      </ul>
      <p>Verification is typically completed within 24 hours.</p>
      <p>Please note that our team may also contact you if additional information or clarification is required to help complete your verification process.</p>
      <p>While your review is ongoing, you can still explore the platform and complete any remaining company profile information to help speed up the process.</p>
      <p>We appreciate your patience and look forward to having your organization onboard.</p>
      <p>Company: <strong>${companyName}</strong></p>
      <p>Warm regards,<br />The WorkaHive Team</p>
  `);
}

export function buildEmployerCompanySubmittedEmailText({ name, companyName }) {
  const displayName = name || "there";

  return `Hello ${displayName},

Thank you for registering as an employer on WorkaHive.

Your company profile has been successfully submitted and is currently under review by our verification team.

As part of our commitment to maintaining a trusted and credible hiring platform, all employer accounts are manually reviewed before job posting access is granted. This verification process may include checks such as:

- Business registration details (e.g. RC Number)
- Social media presence
- Online credibility and brand authenticity
- Other relevant verification criteria

Verification is typically completed within 24 hours.

Please note that our team may also contact you if additional information or clarification is required to help complete your verification process.

While your review is ongoing, you can still explore the platform and complete any remaining company profile information to help speed up the process.

We appreciate your patience and look forward to having your organization onboard.
...
export async function sendEmployerCompanySubmittedEmail({ email, name, companyName }) {
  return sendEmail({
    to: email,
    subject: "Your WorkaHive company profile is under review",
    html: buildEmployerCompanySubmittedEmailHtml({ name, companyName }),
    text: buildEmployerCompanySubmittedEmailText({ name, companyName }),
  });
}
